                                      ...
                                      <div className="relative w-full md:w-64 h-56 md:h-64 overflow-hidden flex-shrink-0 bg-muted">
                                        {item.image_url ? (
                                            ...
                                            <img
                                              ...
                                              onError={(e) => {
                                                ...
                                                if (parent) {
                                                  ...
                                                  fallback.className = 'w-full h-full flex flex-col items-center justify-center bg-muted';
                                                  const icon = document.createElement('div');
                                                  icon.className = 'w-16 h-16 text-muted-foreground mb-2 flex items-center justify-center';
                                                  icon.textContent = '🖼️';
                                                  const label = document.createElement('span');
                                                  label.className = 'text-muted-foreground text-sm';
                                                  label.textContent = language === "th" ? "ไม่สามารถโหลดรูปภาพ" : "Cannot load image";
                                          ...
                                          <div className="w-full h-full flex flex-col items-center justify-center bg-muted">
                                            <svg className="w-16 h-16 text-muted-foreground mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
