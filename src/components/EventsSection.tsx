  ...
  return (
    <>
      <section id="events" className="py-12 sm:py-20 md:py-24 bg-gradient-to-b from-background via-background to-card/20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 relative z-10 overflow-x-hidden">
          {/* Header */}
          ...
          {/* Main Content */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 items-start mb-12 sm:mb-16 md:mb-20">
            {/* Left - Image Gallery */}
            <div className="animate-fade-in space-y-2 sm:space-y-3 md:space-y-4 w-full min-w-0">
              {/* Main Image */}
              <div className="relative group cursor-pointer w-full" onClick={() => openLightbox(selectedImageIndex)}>
              ...
              {/* Thumbnail Strip */}
              {allImages.length > 1 && (
                <div className="flex gap-1.5 sm:gap-2 overflow-x-auto pb-1 scrollbar-hide px-0 w-full">
            ...
            <div className="space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8 animate-fade-in w-full min-w-0">
              {/* Title & Description */}
              <div className="min-w-0">
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-2 sm:mb-3 md:mb-4 font-serif break-words">
                  {title}
                </h3>
                ...
                {displayFeatures.map((feature: any, index: number) => {
                  ...
                  return (
                    <div
                      ...
                      className="group relative p-2.5 sm:p-4 md:p-5 rounded-lg sm:rounded-xl md:rounded-2xl bg-card border border-border/50 hover:border-primary/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 cursor-pointer hover:-translate-y-1 w-full min-w-0"
                    >
                      <div className="flex items-start gap-2 sm:gap-3 md:gap-4 min-w-0">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl md:rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/30 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                          <IconComponent size={16} className="text-primary sm:w-5 sm:h-5 md:w-6 md:h-6" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <h4 className="font-semibold text-foreground text-[11px] sm:text-sm md:text-base mb-0.5 sm:mb-1 group-hover:text-primary transition-colors break-words">
                            {featureTitle}
                          </h4>
              ...
              {/* CTA Button */}
              <div className="pt-2 sm:pt-3 md:pt-6 flex justify-center w-full">
                <div className="group relative inline-block w-full sm:w-auto max-w-full">
                  ...
                  <Button 
                    size="lg" 
                    className="relative w-full sm:w-auto px-3 sm:px-8 md:px-12 lg:px-14 h-10 sm:h-12 md:h-14 lg:h-16 text-xs sm:text-base md:text-lg lg:text-xl font-bold rounded-lg sm:rounded-xl md:rounded-2xl transition-all duration-300 cursor-pointer
                  ...
                  >
                    ...
                    <div className="relative flex items-center gap-1.5 sm:gap-3 md:gap-4 justify-center w-full sm:w-auto min-w-0">
